...
export default function MediaPreviewer({ media }: { media?: components['schemas']['MediaResource'] }) {
  ...
  return (
    preview && (
      <div className="relative w-fit">
        <Image src={preview?.url} className="h-24 w-24" fit="cover" loading="lazy" radius="md" />
        <CloseButton
          size="sm"
