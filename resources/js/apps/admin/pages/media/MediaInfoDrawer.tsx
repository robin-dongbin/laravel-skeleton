      ...
      <div className="mt-4 flex flex-col gap-4">
        <div>
          ...
          <div className="text-sm">
            ...
            <Info label={t('fields.media.created_at')}>{dayjs(media?.created_at).format('YYYY/MM/DD HH:mm:ss')}</Info>
            <Info label={t('fields.media.id')}>{media?.id}</Info>
            <Info label={t('fields.media.aggregate_type')}>{media?.aggregate_type}</Info>
