...
export default function Media() {
	...
	const [previewMedia, setPreviewMedia] =
		useState<components['schemas']['MediaResource']>()
	const [
		uppyDashboardOpened,
		{
			open: openUppyDashboard,
			close: closeUppyDashboard,
			toggle: toggleUppyDashboard,
		},
	] = useDisclosure(false)
	...
	return (
		...
		>
			{uppyDashboardOpened && (
				<UppyDashboard doneButtonHandler={doneButtonHandler} />
			)}
			<Filter />
